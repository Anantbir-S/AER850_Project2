...
model = Sequential([
    ...
    Conv2D(512, (3, 3), kernel_regularizer=tf.keras.regularizers.l2(0.001)),
    BatchNormalization(),
    LeakyReLU(negative_slope=0.2),
    MaxPooling2D((2, 2)),
    Dropout(0.1),
    ...
    Dropout(0.4),  # Higher dropout for fully connected layer
...
history = model.fit(
    ...
    epochs=20,  # Increased epochs to allow for gradual training
...
model_save_path = 'path/to/save/your_model.h5'  # Define the path where you want to save the model
