# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 00:52:27 2024
...
train_datagen = ImageDataGenerator(
    rescale=1./255,
    shear_range=0.15,         # Reduced from 0.2 to 0.15
    zoom_range=0.15,          # Reduced from 0.2 to 0.15
    horizontal_flip=True,
    rotation_range=15,        # Reduced from 20 to 15 degrees
    brightness_range=[0.9, 1.1],  # Narrower brightness range to reduce distortion
